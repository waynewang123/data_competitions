...
class BERTDataset:
    def __init__(self,review,target):
        ...
        :param targets: lists or numpy array which is binary
        """
        self.review = review
        self.target = target
        #we fetch the max len and tokenizer from config.py
    ...
    def __getitem__(self,item):
        ...
        #token type ids behave the same ways as mask in this sepecific case
        #in case of two sentence, this is 0 for first sentence and 1 for second sentence
